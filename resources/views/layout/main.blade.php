...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    @if (auth()->user()->role_id == 1)
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('/')}}/administrator/vehicle">
          <i class="bi bi-life-preserver"></i>
          <span>Vehicle </span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('/')}}/administrator/drivers">
          <i class="bi bi-person-fill"></i>
          <span>Drivers </span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('/')}}/administrator/rental">
          <i class="bi bi-person-fill"></i>
          <span>Rental </span>
        </a>
      </li>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{url('/')}}/agreement/rental">
          <i class="bi bi-person-fill"></i>
          <span>Rental </span>
        </a>
      </li>
